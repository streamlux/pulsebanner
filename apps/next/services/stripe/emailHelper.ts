...
<div class="container mx-auto" style="padding-left: 24px; padding-right: 24px">
    ...
    const bodyText = `<h2><a href="${process.env.NEXTAUTH_URL}/gifts/summary?cs=${gifts[0].checkoutSessionId}">View Gift Purchase Summary</a></h2>`;
    ...
    const footer = `
        <h2><a href="${process.env.NEXTAUTH_URL}/gifts/summary?cs=${gifts[0].checkoutSessionId}">View Gift Purchase Summary</a></h2>
