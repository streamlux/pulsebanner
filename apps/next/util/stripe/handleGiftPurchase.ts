 ...
 */
export async function handleGiftPurchase(giftCouponId: string, amountTotal: number, userId: string, customerEmail: string, priceId: string, checkoutSessionId: string): Promise<GiftPurchase | undefined> {
