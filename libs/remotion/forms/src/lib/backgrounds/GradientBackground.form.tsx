...
export const GradientBackground: LayerForm<Component> = ({ props, setProps, showPricing, accountLevel }) => {
            ...
            <SimpleGrid columns={[1, 2]} spacing={[2, 4]}>
                <FormControl>
                    ...
                    <CustomColorPicker
                        ...
                        onChangeColor={(c) => onChangeProps({ leftColor: c })}
                ...
                <FormControl>
                    ...
                    <CustomColorPicker
                        ...
                        onChangeColor={(c) => onChangeProps({ rightColor: c })}
                        showPricing={showPricing}
                        availableFeature={accountLevel !== 'Free'}
                    />
                </FormControl>
